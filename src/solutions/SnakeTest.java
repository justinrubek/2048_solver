...
public class SnakeTest implements Solver, Callable<TestResult> {
    ...
    public TestResult run() {
        ...
        return new TestResult(board).move_count(i).output(output.toString()).name("SnakeTest").time_taken(end - start).seed(seed);
    ...
    public static float score(GameBoard board) {
        ...
        scores.add(scoreTopLeftDown(board));
        scores.add(scoreTopLeftRight(board));
        scores.add(scoreTopRightDown(board));
        scores.add(scoreTopRightLeft(board));
        scores.add(scoreBottomLeftRight(board));
        scores.add(scoreBottomLeftUp(board));
        scores.add(scoreBottomRightLeft(board));
        scores.add(scoreBottomRightUp(board));
    ...
    /*
        I'd like for these to be changed, maybe build a list of values for snakes from each of the corners
        Then we just run the score on those lists, and their reverse
    */
    static float scoreTopLeftDown(GameBoard board) {
        float decay = 0.25f;
        float score = 0.0f;
    ...
    static float scoreTopLeftRight(GameBoard board) {
        float decay = 0.25f;
        float score = 0.0f;
        boolean reversed = false;
        float weight = 1.0f;
    ...
    static float scoreTopRightDown(GameBoard board) {
        float decay = 0.25f;
        float score = 0.0f;
        boolean reversed = false;
        float weight = 1.0f;
    ...
    static float scoreTopRightLeft(GameBoard board) {
        float decay = 0.25f;
        float score = 0.0f;
    ...
    static float scoreBottomLeftRight(GameBoard board) {
        float decay = 0.25f;
        float score = 0.0f;
        boolean reversed = false;
        float weight = 1.0f;
    ...
    static float scoreBottomLeftUp(GameBoard board) {
        float decay = 0.25f;
        float score = 0.0f;
        boolean reversed = true;
        float weight = 1.0f;
   ...
   static  float scoreBottomRightUp(GameBoard board) {
        float decay = 0.25f;
        float score = 0.0f;
        boolean reversed = true;
        float weight = 1.0f;
    ...
    static float scoreBottomRightLeft(GameBoard board) {
        float decay = 0.25f;
        float score = 0.0f;
        boolean reversed = true;
        float weight = 1.0f;
